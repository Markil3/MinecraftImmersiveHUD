                        ...
                        (float) value.getMaxTime() / TICKS_PER_SECOND)
                            ...
                            .setTooltip(new TranslatableText(
                                    "tooltip.immersive_hud." + name +
                                            "MaxTime"))
                            .setSaveConsumer(val -> value
                                    .setMaxTime((int) (val * TICKS_PER_SECOND)))
                            .build();
                        ...
                        (float) value.getFadeInTime() / TICKS_PER_SECOND)
                            ...
                            .setTooltip(new TranslatableText(
                                    "tooltip.immersive_hud." + name +
                                            "FadeIn"))
                            .setSaveConsumer(val -> value
                                    .setFadeInTime((int) (val * TICKS_PER_SECOND)))
                            .build();
                        ...
                        (float) value.getFadeOutTime() / TICKS_PER_SECOND)
                            ...
                            .setTooltip(new TranslatableText(
                                    "tooltip.immersive_hud." + name +
                                            "FadeOut"))
                            .setSaveConsumer(val -> value
                                    .setFadeOutTime((int) (val * TICKS_PER_SECOND)))
                            .build();
        ...
        return screen -> {
            ...
            final ConfigBuilder builder = ConfigBuilder.create()
                                                       ...
                                                       .setSavingRunnable(() -> {
                                                           ...
                                                           {
                                                               if (Class
                                                                       .forName("me.shedaniel.autoconfig.AutoConfig") != null)
                                                               {
                                                                   AutoConfig
                                                                           .getConfigHolder(ConfigManagerCloth.class)
                                                                           .save();
                                                               }
                                                           }
